 ...
 */
public class AutoResizableTextView extends TextView {
    ...
    public AutoResizableTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    // Default constructor override
    public AutoResizableTextView(Context context, AttributeSet attrs, int defStyle) {
